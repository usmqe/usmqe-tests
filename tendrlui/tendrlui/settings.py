...
class Settings(object):
    ...
    def __init__(self):
        ...
        self.tendrlui = TendrluiSettings()
    ...
    def _configure_logging(self):
        ...
        logging.basicConfig(
            ...
            datefmt='%Y-%m-%d %H:%M:%S',
            level=self.tendrlui.verbosity
        )
        logging.getLogger('tendrlui').setLevel(self.tendrlui.verbosity)

    def _configure_thirdparty_logging(self):
        logging.getLogger('widgetastic_null').setLevel(self.tendrlui.verbosity)
