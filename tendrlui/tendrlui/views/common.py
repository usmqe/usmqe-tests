...
class LCESelectorGroup(ParametrizedView):
    """Group of :class:`tendrlui.widgets.LCESelector`, typically present on page
    ...
    def fill(self, values=None):
        ...
        :class:`tendrlui.widgets.LCESelector` widget. Usage remains the same as
        :class:`tendrlui.widgets.LCESelector` and
...
class SearchableViewMixin(WTMixin):
    """Mixin which adds :class:`tendrlui.widgets.Search` widget and
