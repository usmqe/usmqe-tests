"""Tendrl's implementation of base navigation and navigate steps."""
import navmazing
...
class NavigateStep(navmazing.NavigateStep):
    """Tendrl's version of :class:`navmazing.NavigateStep` with custom
    ...
    def create_view(self, view_class, additional_context=None):
        ...
        :class:`tendrlui.browser.TendrluiBrowser` and
        :class:`tendrlui.session.Session` set as instance attributes
    ...
    def am_i_here(self, *args, **kwargs):
        ...
        By default, tendrlui relies on view's ``is_displayed`` property to
...
class Navigate(navmazing.Navigate):
    """Wrapper around :class:`navmazing.Navigate` which adds tendrlui browser as
    class attribute.
    ...
    def __init__(self, browser=None):
        """Store tendrlui browser instance to be able to perform navigation
        steps.

        :param tendrlui.browser.TendrluiBrowser browser: tendrlui browser instance to
...
# navigation use :attr:`tendrlui.Session.navigate_to` instead.
navigator = Navigate()
