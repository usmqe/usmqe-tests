...
from tendrlui.base.application import Application
from tendrlui.base.application.implementations import TendrluiImplementationContext
from tendrlui.base.modeling import BaseEntity, BaseCollection
#from tendrlui.base.application.implementations.rest_api import RESTAPI
from tendrlui.base.application.implementations.web_ui import TendrluiNavigateStep, WebUI
from tendrlui.views.domain import (
    DomainCreateView,
    DomainEditView,
    DomainListView,
)
...
@TendrluiImplementationContext.external_for(DomainsCollection.create, WebUI)
...
'''
@TendrluiImplementationContext.external_for(DomainsCollection.create, RESTAPI)
def create(self, dns_domain, full_name=None, dns_capsule=None, parameters=None, locations=None,
           organizations=None):
...
class DomainList(TendrluiNavigateStep):
    VIEW = DomainListView
...
class AddNewDomain(TendrluiNavigateStep):
...
class EditDomain(TendrluiNavigateStep):
    VIEW = DomainEditView
    prerequisite = NavigateToAttribute('parent.web_ui', 'Domains')
