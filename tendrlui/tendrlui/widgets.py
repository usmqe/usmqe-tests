...
from tendrlui.exceptions import ReadOnlyWidgetError
...
class ContextSelector(Widget):
    ...
    def read(self):
        ...
        calling :meth:`tendrlui.views.common.BaseLoggedInView.read` for any view
...
class LCESelector(GenericLocatorWidget):
    ...
    def __init__(self, parent, locator=None, logger=None):
        ...
        typically as a part of :class:`tendrlui.views.common.LCESelectorGroup`.
        """
        if locator is None:
            locator = (
