...
# Add the Tendrl root directory to the system path. This allows references
# such as :mod:`tendrlui.browser` to be processed correctly.
sys.path.insert(
    0,
...
nitpick_ignore = [
    ...
    ('py:class', 'tendrlui.views.common.BaseLoggedInView'),
    ('py:meth', 'widgetastic.browser.Browser.move_to_element'),
    ('py:meth', 'tendrlui.views.common.BaseLoggedInView.read'),
